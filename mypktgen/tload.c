...
int load_trace_line(FILE *fp, struct packet_model *pm, uint64_t src_mac, uint64_t dst_mac)
{
    ...
    if(proto == 6)
    {
        ...
        // pm->tcp.tcp.sent_seq = htonl(cnt++);
        pm->tcp.tcp.sent_seq = cnt++;
...
// */
//         // src: 90:e2:ba:2f:82:e4
//         pm->udp.eth.s_addr.addr_bytes[0] = (uint8_t)0x90;
//         pm->udp.eth.s_addr.addr_bytes[1] = (uint8_t)0xe2;
//         pm->udp.eth.s_addr.addr_bytes[2] = (uint8_t)0xba;
//         pm->udp.eth.s_addr.addr_bytes[3] = (uint8_t)0x2f;
//         pm->udp.eth.s_addr.addr_bytes[4] = (uint8_t)0x82;
//         pm->udp.eth.s_addr.addr_bytes[5] = (uint8_t)0xe4;



//         // dst: 90:e2:ba:86:78:d8
//         pm->udp.eth.d_addr.addr_bytes[0] = (uint8_t)0x90;
//         pm->udp.eth.d_addr.addr_bytes[1] = (uint8_t)0xe2;
//         pm->udp.eth.d_addr.addr_bytes[2] = (uint8_t)0xba;
//         pm->udp.eth.d_addr.addr_bytes[3] = (uint8_t)0x86;
//         pm->udp.eth.d_addr.addr_bytes[4] = (uint8_t)0x78;
//         pm->udp.eth.d_addr.addr_bytes[5] = (uint8_t)0xd8;
