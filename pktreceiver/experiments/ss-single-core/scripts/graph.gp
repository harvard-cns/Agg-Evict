...
# set yrange [10:100]
set logscale x
plot 'Cuckoo-3-tmp.csv' using ($2/(1024*1024)):($7/(2.3))            title 'Cuckoo-3' w lp ls 2,'CuckooBucket-3-tmp.csv' using ($2/(1024*1024)):($7/(2.3))            title 'CuckooBucket-3' w lp ls 5,'Linear-3-tmp.csv' using ($2/(1024*1024)):($7/(2.3))            title 'Linear-3' w lp ls 4,'Simple-3-tmp.csv' using ($2/(1024*1024)):($7/(2.3))            title 'Simple-3' w lp ls 5,