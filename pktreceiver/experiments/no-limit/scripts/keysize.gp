...
plot 'Cuckoo-12-tmp.csv'        using ($3/(1)):($10/(1)) title 'Cuckoo (48)' w lp ls 1,\
     'Cuckoo-3-tmp.csv'         using ($3/(1)):($10/(1)) title 'Cuckoo (12)' w lp ls 2,\
     'CuckooBucket-12-tmp.csv'  using ($3/(1)):($10/(1)) title 'Cuckoo Bkt (48)' w lp ls 3,\
     'CuckooBucket-3-tmp.csv'   using ($3/(1)):($10/(1)) title 'Cuckoo Bkt (12)' w lp ls 4,\
     'Linear-12-tmp.csv'        using ($3/(1)):($10/(1)) title 'Linear (48)' w lp ls 5,\
     'Linear-3-tmp.csv'         using ($3/(1)):($10/(1)) title 'Linear (12)' w lp ls 6
